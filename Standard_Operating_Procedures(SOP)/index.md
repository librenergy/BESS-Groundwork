...
One `.md` per procedure while it is a single document; its own subfolder once it acquires companions: the issued PDF, acknowledgement records, a counterparty's redline. Subfolders are plain-named, no acronym ([taxonomy §2b](../Ontology%28ONT%29/taxonomy.md)).
