...
* [Metrics Tree](metrics-tree.md) - The tree (how contract value decomposes through LDs and guarantees, into the OBE engineering measurement layer, down to what gets monitored) plus the per-segment metric registry: PG-xxx contractual rows referencing the PGM, MT_ owner metrics with one calculation sheet each.
