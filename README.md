...
9. **RACI Matrix** — who is responsible/accountable for each event and process, plus the escalation & communication sections (who calls whom, severity levels, notification deadlines; they also build on the Contact Register).
