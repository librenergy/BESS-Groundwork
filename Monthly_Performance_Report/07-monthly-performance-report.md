...
*Sources: reconciled ledger (Outage Procedure §3) — APM + LTSA CMMS + ISO OMS*
...
*Sources: APM / data platform (BMS chain: String BMS → Master BMS), capacity tests, MAXENER history*
...
*Source: Obligation Matrix + claims log*
