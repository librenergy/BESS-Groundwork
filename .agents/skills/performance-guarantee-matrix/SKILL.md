...
2. One `calc-{contract}-{metric}.md` sheet per guarantee, individually reviewable.
3. The exclusions-asymmetry table → retained-risk register input.
4. Shadow-calculation requirements → Data Interface Register and Metrics & KPIs skills; pre-COD data-capture punch list.
