...
> **v1.1** · [Librenergy](https://librenergy.com)
>
...
>
> **Copy of Diagram**: a copy of the diagram is available on Librenergy's Lucidechart (user must be logged in with free account): https://lucid.app/lucidchart/9286075c-652a-4d76-b85a-e33e1dd83b91/edit?invitationId=inv_0446caff-e84b-4ff4-8406-49fb09ddf45c
  ...
  subgraph BESS["BESS Asset"]
      ...
      subgraph Substation["Substation"]
        ...
        subgraph GTEL["ISO Telemetry"]
            ...
            OP_Metrics["Operationnal Metrics"]:::data
        end
    ...
    %% PCS OEM
    PCS_OEM --> PCS_OEM_CMMS["Bat OEM CMMS"]:::data
    ...
    SUB_LTSA --- SUB_SPARES["Substaiton Spares"]:::asset
