...
* [Taxonomy (naming)](taxonomy.md) - How things are named: organization codes, segment hierarchy and instance-code grammar, topic paths, prefix/ID conventions, and the identifier-scheme registry (segment types, measurement terms, PG-xxx, MT_). Moved here from Definitions_Taxonomy(DT) 2026-08-31.
